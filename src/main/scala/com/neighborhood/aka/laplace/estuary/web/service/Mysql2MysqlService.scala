...
final class Mysql2MysqlService extends SyncService[Mysql2MysqlRequestBean] {
  ...
  private def customRequestForSda(taskRequestBean: Mysql2MysqlRequestBean): Unit = {
    ...
    taskRequestBean.getMysql2MysqlRunningInfoBean.getFetcherNameToLoad.put("directFetcher", "com.neighborhood.aka.laplace.estuary.mysql.lifecycle.reborn.batch.imp.MysqlBinlogInOrderMysqlSpecialInfoSender4Sda") //强制sda
