...
public class EstuaryZkClient extends ZkClient {
    ...
    public EstuaryZkClient(String zkServers, int connectionTimeout) {
        this(new EstuaryZookeeper(zkServers), connectionTimeout);
    }

    public EstuaryZkClient(String zkServers, int sessionTimeout, int connectionTimeout) {
        this(new EstuaryZookeeper(zkServers, sessionTimeout), connectionTimeout);
    }

    public EstuaryZkClient(String zkServers, int sessionTimeout, int connectionTimeout, ZkSerializer zkSerializer) {
        super(new EstuaryZookeeper(zkServers, sessionTimeout), connectionTimeout, zkSerializer);
    }


    public EstuaryZkClient(IZkConnection connection, int connectionTimeout) {
        this(connection, connectionTimeout, new ByteSerializer());
    }

    public EstuaryZkClient(IZkConnection zkConnection, int connectionTimeout, ZkSerializer zkSerializer) {
