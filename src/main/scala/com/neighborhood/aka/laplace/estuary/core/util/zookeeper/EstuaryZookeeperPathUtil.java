...
public class EstuaryZookeeperPathUtil {
    ...
    public static final String ESTUARY_ROOT_NODE = ZOOKEEPER_SEPARATOR + "estuary";

    public static final String CANAL_ROOT_NODE = ESTUARY_ROOT_NODE;
