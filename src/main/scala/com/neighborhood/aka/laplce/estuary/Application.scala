package com.neighborhood.aka.laplce.estuary
...
import com.neighborhood.aka.laplce.estuary.core.lifecycle.SyncControllerMessage
...
object Application extends theActorSystem {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val mysql2KafkaTaskInfoManager = buildManager(config, taskInfoBean)
